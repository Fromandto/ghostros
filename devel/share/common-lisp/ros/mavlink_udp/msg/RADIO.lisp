...
(cl:defmethod cl:initialize-instance :after ((m <RADIO>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RADIO)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<RADIO> is deprecated: use mavlink_udp-msg:RADIO instead.")))
...
(cl:defmethod rssi-val ((m <RADIO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:rssi-val is deprecated.  Use mavlink_udp-msg:rssi instead.")
  (rssi m))

(cl:ensure-generic-function 'remrssi-val :lambda-list '(m))
(cl:defmethod remrssi-val ((m <RADIO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:remrssi-val is deprecated.  Use mavlink_udp-msg:remrssi instead.")
  (remrssi m))

(cl:ensure-generic-function 'txbuf-val :lambda-list '(m))
(cl:defmethod txbuf-val ((m <RADIO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:txbuf-val is deprecated.  Use mavlink_udp-msg:txbuf instead.")
  (txbuf m))

(cl:ensure-generic-function 'noise-val :lambda-list '(m))
(cl:defmethod noise-val ((m <RADIO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:noise-val is deprecated.  Use mavlink_udp-msg:noise instead.")
  (noise m))

(cl:ensure-generic-function 'remnoise-val :lambda-list '(m))
(cl:defmethod remnoise-val ((m <RADIO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:remnoise-val is deprecated.  Use mavlink_udp-msg:remnoise instead.")
  (remnoise m))

(cl:ensure-generic-function 'rxerrors-val :lambda-list '(m))
(cl:defmethod rxerrors-val ((m <RADIO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:rxerrors-val is deprecated.  Use mavlink_udp-msg:rxerrors instead.")
  (rxerrors m))

(cl:ensure-generic-function 'fixed-val :lambda-list '(m))
(cl:defmethod fixed-val ((m <RADIO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:fixed-val is deprecated.  Use mavlink_udp-msg:fixed instead.")
  (fixed m))
