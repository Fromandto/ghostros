...
(cl:defmethod cl:initialize-instance :after ((m <HWSTATUS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HWSTATUS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<HWSTATUS> is deprecated: use mavlink_udp-msg:HWSTATUS instead.")))
...
(cl:defmethod Vcc-val ((m <HWSTATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:Vcc-val is deprecated.  Use mavlink_udp-msg:Vcc instead.")
  (Vcc m))

(cl:ensure-generic-function 'I2Cerr-val :lambda-list '(m))
(cl:defmethod I2Cerr-val ((m <HWSTATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:I2Cerr-val is deprecated.  Use mavlink_udp-msg:I2Cerr instead.")
  (I2Cerr m))
