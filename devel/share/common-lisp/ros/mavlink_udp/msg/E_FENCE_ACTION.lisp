...
(cl:defmethod cl:initialize-instance :after ((m <E_FENCE_ACTION>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'E_FENCE_ACTION)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<E_FENCE_ACTION> is deprecated: use mavlink_udp-msg:E_FENCE_ACTION instead.")))
