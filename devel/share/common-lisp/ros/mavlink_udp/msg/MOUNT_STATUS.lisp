...
(cl:defmethod cl:initialize-instance :after ((m <MOUNT_STATUS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MOUNT_STATUS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<MOUNT_STATUS> is deprecated: use mavlink_udp-msg:MOUNT_STATUS instead.")))
...
(cl:defmethod pointing_a-val ((m <MOUNT_STATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:pointing_a-val is deprecated.  Use mavlink_udp-msg:pointing_a instead.")
  (pointing_a m))

(cl:ensure-generic-function 'pointing_b-val :lambda-list '(m))
(cl:defmethod pointing_b-val ((m <MOUNT_STATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:pointing_b-val is deprecated.  Use mavlink_udp-msg:pointing_b instead.")
  (pointing_b m))

(cl:ensure-generic-function 'pointing_c-val :lambda-list '(m))
(cl:defmethod pointing_c-val ((m <MOUNT_STATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:pointing_c-val is deprecated.  Use mavlink_udp-msg:pointing_c instead.")
  (pointing_c m))
