...
(cl:defmethod cl:initialize-instance :after ((m <E_LIMITS_STATE>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'E_LIMITS_STATE)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<E_LIMITS_STATE> is deprecated: use mavlink_udp-msg:E_LIMITS_STATE instead.")))
