...
(cl:defmethod cl:initialize-instance :after ((m <MOUNT_CONFIGURE>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MOUNT_CONFIGURE)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<MOUNT_CONFIGURE> is deprecated: use mavlink_udp-msg:MOUNT_CONFIGURE instead.")))
...
(cl:defmethod mount_mode-val ((m <MOUNT_CONFIGURE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:mount_mode-val is deprecated.  Use mavlink_udp-msg:mount_mode instead.")
  (mount_mode m))

(cl:ensure-generic-function 'stab_roll-val :lambda-list '(m))
(cl:defmethod stab_roll-val ((m <MOUNT_CONFIGURE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:stab_roll-val is deprecated.  Use mavlink_udp-msg:stab_roll instead.")
  (stab_roll m))

(cl:ensure-generic-function 'stab_pitch-val :lambda-list '(m))
(cl:defmethod stab_pitch-val ((m <MOUNT_CONFIGURE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:stab_pitch-val is deprecated.  Use mavlink_udp-msg:stab_pitch instead.")
  (stab_pitch m))

(cl:ensure-generic-function 'stab_yaw-val :lambda-list '(m))
(cl:defmethod stab_yaw-val ((m <MOUNT_CONFIGURE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:stab_yaw-val is deprecated.  Use mavlink_udp-msg:stab_yaw instead.")
  (stab_yaw m))
