...
(cl:defmethod cl:initialize-instance :after ((m <E_MAV_MOUNT_MODE>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'E_MAV_MOUNT_MODE)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<E_MAV_MOUNT_MODE> is deprecated: use mavlink_udp-msg:E_MAV_MOUNT_MODE instead.")))
