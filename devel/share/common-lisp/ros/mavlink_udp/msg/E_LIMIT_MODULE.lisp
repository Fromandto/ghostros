...
(cl:defmethod cl:initialize-instance :after ((m <E_LIMIT_MODULE>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'E_LIMIT_MODULE)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<E_LIMIT_MODULE> is deprecated: use mavlink_udp-msg:E_LIMIT_MODULE instead.")))
