...
(cl:defmethod cl:initialize-instance :after ((m <MAV_RAW_DATA>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MAV_RAW_DATA)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<MAV_RAW_DATA> is deprecated: use mavlink_udp-msg:MAV_RAW_DATA instead.")))

(cl:ensure-generic-function 'channel-val :lambda-list '(m))
(cl:defmethod channel-val ((m <MAV_RAW_DATA>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:channel-val is deprecated.  Use mavlink_udp-msg:channel instead.")
  (channel m))
