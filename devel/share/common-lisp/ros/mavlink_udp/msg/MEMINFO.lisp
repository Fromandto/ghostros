...
(cl:defmethod cl:initialize-instance :after ((m <MEMINFO>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MEMINFO)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<MEMINFO> is deprecated: use mavlink_udp-msg:MEMINFO instead.")))
...
(cl:defmethod brkval-val ((m <MEMINFO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:brkval-val is deprecated.  Use mavlink_udp-msg:brkval instead.")
  (brkval m))

(cl:ensure-generic-function 'freemem-val :lambda-list '(m))
(cl:defmethod freemem-val ((m <MEMINFO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:freemem-val is deprecated.  Use mavlink_udp-msg:freemem instead.")
  (freemem m))
