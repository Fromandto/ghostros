...
(cl:defmethod cl:initialize-instance :after ((m <MOUNT_CONTROL>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MOUNT_CONTROL)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<MOUNT_CONTROL> is deprecated: use mavlink_udp-msg:MOUNT_CONTROL instead.")))
...
(cl:defmethod input_a-val ((m <MOUNT_CONTROL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:input_a-val is deprecated.  Use mavlink_udp-msg:input_a instead.")
  (input_a m))

(cl:ensure-generic-function 'input_b-val :lambda-list '(m))
(cl:defmethod input_b-val ((m <MOUNT_CONTROL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:input_b-val is deprecated.  Use mavlink_udp-msg:input_b instead.")
  (input_b m))

(cl:ensure-generic-function 'input_c-val :lambda-list '(m))
(cl:defmethod input_c-val ((m <MOUNT_CONTROL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:input_c-val is deprecated.  Use mavlink_udp-msg:input_c instead.")
  (input_c m))

(cl:ensure-generic-function 'save_position-val :lambda-list '(m))
(cl:defmethod save_position-val ((m <MOUNT_CONTROL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:save_position-val is deprecated.  Use mavlink_udp-msg:save_position instead.")
  (save_position m))
