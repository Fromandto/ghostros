...
(cl:defmethod cl:initialize-instance :after ((m <SET_MAG_OFFSETS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SET_MAG_OFFSETS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<SET_MAG_OFFSETS> is deprecated: use mavlink_udp-msg:SET_MAG_OFFSETS instead.")))
