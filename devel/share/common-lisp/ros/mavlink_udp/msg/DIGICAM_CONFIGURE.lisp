...
(cl:defmethod cl:initialize-instance :after ((m <DIGICAM_CONFIGURE>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DIGICAM_CONFIGURE)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_udp-msg:<DIGICAM_CONFIGURE> is deprecated: use mavlink_udp-msg:DIGICAM_CONFIGURE instead.")))
...
(cl:defmethod mode-val ((m <DIGICAM_CONFIGURE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:mode-val is deprecated.  Use mavlink_udp-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'shutter_speed-val :lambda-list '(m))
(cl:defmethod shutter_speed-val ((m <DIGICAM_CONFIGURE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:shutter_speed-val is deprecated.  Use mavlink_udp-msg:shutter_speed instead.")
  (shutter_speed m))

(cl:ensure-generic-function 'aperture-val :lambda-list '(m))
(cl:defmethod aperture-val ((m <DIGICAM_CONFIGURE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:aperture-val is deprecated.  Use mavlink_udp-msg:aperture instead.")
  (aperture m))

(cl:ensure-generic-function 'iso-val :lambda-list '(m))
(cl:defmethod iso-val ((m <DIGICAM_CONFIGURE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:iso-val is deprecated.  Use mavlink_udp-msg:iso instead.")
  (iso m))

(cl:ensure-generic-function 'exposure_type-val :lambda-list '(m))
(cl:defmethod exposure_type-val ((m <DIGICAM_CONFIGURE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:exposure_type-val is deprecated.  Use mavlink_udp-msg:exposure_type instead.")
  (exposure_type m))
...
(cl:defmethod engine_cut_off-val ((m <DIGICAM_CONFIGURE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_udp-msg:engine_cut_off-val is deprecated.  Use mavlink_udp-msg:engine_cut_off instead.")
  (engine_cut_off m))
