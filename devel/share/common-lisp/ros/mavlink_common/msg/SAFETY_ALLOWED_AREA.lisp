...
;//! \htmlinclude SAFETY_ALLOWED_AREA.msg.html

(cl:defclass <SAFETY_ALLOWED_AREA> (roslisp-msg-protocol:ros-message)
  ((sysid
    :reader sysid
    :initarg :sysid
    :type cl:fixnum
...
(cl:defclass SAFETY_ALLOWED_AREA (<SAFETY_ALLOWED_AREA>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SAFETY_ALLOWED_AREA>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SAFETY_ALLOWED_AREA)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_common-msg:<SAFETY_ALLOWED_AREA> is deprecated: use mavlink_common-msg:SAFETY_ALLOWED_AREA instead.")))

(cl:ensure-generic-function 'sysid-val :lambda-list '(m))
(cl:defmethod sysid-val ((m <SAFETY_ALLOWED_AREA>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_common-msg:sysid-val is deprecated.  Use mavlink_common-msg:sysid instead.")
  (sysid m))

(cl:ensure-generic-function 'compid-val :lambda-list '(m))
(cl:defmethod compid-val ((m <SAFETY_ALLOWED_AREA>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_common-msg:compid-val is deprecated.  Use mavlink_common-msg:compid instead.")
  (compid m))

(cl:ensure-generic-function 'frame-val :lambda-list '(m))
(cl:defmethod frame-val ((m <SAFETY_ALLOWED_AREA>))
...
(cl:defmethod p1x-val ((m <SAFETY_ALLOWED_AREA>))
...
(cl:defmethod p1y-val ((m <SAFETY_ALLOWED_AREA>))
...
(cl:defmethod p1z-val ((m <SAFETY_ALLOWED_AREA>))
...
(cl:defmethod p2x-val ((m <SAFETY_ALLOWED_AREA>))
...
(cl:defmethod p2y-val ((m <SAFETY_ALLOWED_AREA>))
...
(cl:defmethod p2z-val ((m <SAFETY_ALLOWED_AREA>))
  ...
  (p2z m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<SAFETY_ALLOWED_AREA>)))
    "Constants for message type '<SAFETY_ALLOWED_AREA>"
  '((:ID . 55))
)
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql 'SAFETY_ALLOWED_AREA)))
    "Constants for message type 'SAFETY_ALLOWED_AREA"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SAFETY_ALLOWED_AREA>) ostream)
  "Serializes a message object of type '<SAFETY_ALLOWED_AREA>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SAFETY_ALLOWED_AREA>) istream)
  "Deserializes a message object of type '<SAFETY_ALLOWED_AREA>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SAFETY_ALLOWED_AREA>)))
  "Returns string type for a message object of type '<SAFETY_ALLOWED_AREA>"
  "mavlink_common/SAFETY_ALLOWED_AREA")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SAFETY_ALLOWED_AREA)))
  "Returns string type for a message object of type 'SAFETY_ALLOWED_AREA"
  "mavlink_common/SAFETY_ALLOWED_AREA")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SAFETY_ALLOWED_AREA>)))
  "Returns md5sum for a message object of type '<SAFETY_ALLOWED_AREA>"
  "ed1a04a3c67e68447c75bbefa087029a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SAFETY_ALLOWED_AREA)))
  "Returns md5sum for a message object of type 'SAFETY_ALLOWED_AREA"
  "ed1a04a3c67e68447c75bbefa087029a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SAFETY_ALLOWED_AREA>)))
  "Returns full string definition for message of type '<SAFETY_ALLOWED_AREA>"
  (cl:format cl:nil "# Automatically Generated in 2014-08-12 13:24:39.908732~%# MESSAGE: SAFETY_ALLOWED_AREA~%# Description:Read out the safety zone the MAV currently assumes.~%uint8 ID = 55~%uint8 sysid~%uint8 compid~%uint8 frame~%float32 p1x~%float32 p1y~%float32 p1z~%float32 p2x~%float32 p2y~%float32 p2z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SAFETY_ALLOWED_AREA)))
  "Returns full string definition for message of type 'SAFETY_ALLOWED_AREA"
  (cl:format cl:nil "# Automatically Generated in 2014-08-12 13:24:39.908732~%# MESSAGE: SAFETY_ALLOWED_AREA~%# Description:Read out the safety zone the MAV currently assumes.~%uint8 ID = 55~%uint8 sysid~%uint8 compid~%uint8 frame~%float32 p1x~%float32 p1y~%float32 p1z~%float32 p2x~%float32 p2y~%float32 p2z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SAFETY_ALLOWED_AREA>))
  (cl:+ 0
     1
     1
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SAFETY_ALLOWED_AREA>))
  "Converts a ROS message object to a list"
  (cl:list 'SAFETY_ALLOWED_AREA
