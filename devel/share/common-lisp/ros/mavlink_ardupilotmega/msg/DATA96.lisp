...
(cl:defmethod cl:initialize-instance :after ((m <DATA96>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DATA96)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_ardupilotmega-msg:<DATA96> is deprecated: use mavlink_ardupilotmega-msg:DATA96 instead.")))
