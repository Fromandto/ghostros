...
(cl:defmethod cl:initialize-instance :after ((m <SENSOR_OFFSETS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SENSOR_OFFSETS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_ardupilotmega-msg:<SENSOR_OFFSETS> is deprecated: use mavlink_ardupilotmega-msg:SENSOR_OFFSETS instead.")))
...
(cl:defmethod mag_declination-val ((m <SENSOR_OFFSETS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:mag_declination-val is deprecated.  Use mavlink_ardupilotmega-msg:mag_declination instead.")
  (mag_declination m))

(cl:ensure-generic-function 'raw_press-val :lambda-list '(m))
(cl:defmethod raw_press-val ((m <SENSOR_OFFSETS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:raw_press-val is deprecated.  Use mavlink_ardupilotmega-msg:raw_press instead.")
  (raw_press m))

(cl:ensure-generic-function 'raw_temp-val :lambda-list '(m))
(cl:defmethod raw_temp-val ((m <SENSOR_OFFSETS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:raw_temp-val is deprecated.  Use mavlink_ardupilotmega-msg:raw_temp instead.")
  (raw_temp m))

(cl:ensure-generic-function 'gyro_cal_x-val :lambda-list '(m))
(cl:defmethod gyro_cal_x-val ((m <SENSOR_OFFSETS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:gyro_cal_x-val is deprecated.  Use mavlink_ardupilotmega-msg:gyro_cal_x instead.")
  (gyro_cal_x m))

(cl:ensure-generic-function 'gyro_cal_y-val :lambda-list '(m))
(cl:defmethod gyro_cal_y-val ((m <SENSOR_OFFSETS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:gyro_cal_y-val is deprecated.  Use mavlink_ardupilotmega-msg:gyro_cal_y instead.")
  (gyro_cal_y m))

(cl:ensure-generic-function 'gyro_cal_z-val :lambda-list '(m))
(cl:defmethod gyro_cal_z-val ((m <SENSOR_OFFSETS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:gyro_cal_z-val is deprecated.  Use mavlink_ardupilotmega-msg:gyro_cal_z instead.")
  (gyro_cal_z m))

(cl:ensure-generic-function 'accel_cal_x-val :lambda-list '(m))
(cl:defmethod accel_cal_x-val ((m <SENSOR_OFFSETS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:accel_cal_x-val is deprecated.  Use mavlink_ardupilotmega-msg:accel_cal_x instead.")
  (accel_cal_x m))

(cl:ensure-generic-function 'accel_cal_y-val :lambda-list '(m))
(cl:defmethod accel_cal_y-val ((m <SENSOR_OFFSETS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:accel_cal_y-val is deprecated.  Use mavlink_ardupilotmega-msg:accel_cal_y instead.")
  (accel_cal_y m))

(cl:ensure-generic-function 'accel_cal_z-val :lambda-list '(m))
(cl:defmethod accel_cal_z-val ((m <SENSOR_OFFSETS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:accel_cal_z-val is deprecated.  Use mavlink_ardupilotmega-msg:accel_cal_z instead.")
  (accel_cal_z m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SENSOR_OFFSETS>)))
  ...
  "mavlink_ardupilotmega/SENSOR_OFFSETS")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SENSOR_OFFSETS)))
  "Returns string type for a message object of type 'SENSOR_OFFSETS"
  "mavlink_ardupilotmega/SENSOR_OFFSETS")
