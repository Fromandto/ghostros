...
(cl:defmethod cl:initialize-instance :after ((m <DATA64>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DATA64)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_ardupilotmega-msg:<DATA64> is deprecated: use mavlink_ardupilotmega-msg:DATA64 instead.")))
