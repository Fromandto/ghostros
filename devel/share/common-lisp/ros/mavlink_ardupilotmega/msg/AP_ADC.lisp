...
(cl:defmethod cl:initialize-instance :after ((m <AP_ADC>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AP_ADC)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_ardupilotmega-msg:<AP_ADC> is deprecated: use mavlink_ardupilotmega-msg:AP_ADC instead.")))
...
(cl:defmethod adc1-val ((m <AP_ADC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:adc1-val is deprecated.  Use mavlink_ardupilotmega-msg:adc1 instead.")
  (adc1 m))

(cl:ensure-generic-function 'adc2-val :lambda-list '(m))
(cl:defmethod adc2-val ((m <AP_ADC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:adc2-val is deprecated.  Use mavlink_ardupilotmega-msg:adc2 instead.")
  (adc2 m))

(cl:ensure-generic-function 'adc3-val :lambda-list '(m))
(cl:defmethod adc3-val ((m <AP_ADC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:adc3-val is deprecated.  Use mavlink_ardupilotmega-msg:adc3 instead.")
  (adc3 m))

(cl:ensure-generic-function 'adc4-val :lambda-list '(m))
(cl:defmethod adc4-val ((m <AP_ADC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:adc4-val is deprecated.  Use mavlink_ardupilotmega-msg:adc4 instead.")
  (adc4 m))

(cl:ensure-generic-function 'adc5-val :lambda-list '(m))
(cl:defmethod adc5-val ((m <AP_ADC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:adc5-val is deprecated.  Use mavlink_ardupilotmega-msg:adc5 instead.")
  (adc5 m))

(cl:ensure-generic-function 'adc6-val :lambda-list '(m))
(cl:defmethod adc6-val ((m <AP_ADC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:adc6-val is deprecated.  Use mavlink_ardupilotmega-msg:adc6 instead.")
  (adc6 m))
