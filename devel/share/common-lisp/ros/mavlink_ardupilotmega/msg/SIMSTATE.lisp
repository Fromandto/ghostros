...
(cl:defmethod cl:initialize-instance :after ((m <SIMSTATE>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SIMSTATE)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_ardupilotmega-msg:<SIMSTATE> is deprecated: use mavlink_ardupilotmega-msg:SIMSTATE instead.")))
...
(cl:defmethod roll-val ((m <SIMSTATE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:roll-val is deprecated.  Use mavlink_ardupilotmega-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <SIMSTATE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:pitch-val is deprecated.  Use mavlink_ardupilotmega-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <SIMSTATE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:yaw-val is deprecated.  Use mavlink_ardupilotmega-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'xacc-val :lambda-list '(m))
(cl:defmethod xacc-val ((m <SIMSTATE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:xacc-val is deprecated.  Use mavlink_ardupilotmega-msg:xacc instead.")
  (xacc m))

(cl:ensure-generic-function 'yacc-val :lambda-list '(m))
(cl:defmethod yacc-val ((m <SIMSTATE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:yacc-val is deprecated.  Use mavlink_ardupilotmega-msg:yacc instead.")
  (yacc m))

(cl:ensure-generic-function 'zacc-val :lambda-list '(m))
(cl:defmethod zacc-val ((m <SIMSTATE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:zacc-val is deprecated.  Use mavlink_ardupilotmega-msg:zacc instead.")
  (zacc m))

(cl:ensure-generic-function 'xgyro-val :lambda-list '(m))
(cl:defmethod xgyro-val ((m <SIMSTATE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:xgyro-val is deprecated.  Use mavlink_ardupilotmega-msg:xgyro instead.")
  (xgyro m))

(cl:ensure-generic-function 'ygyro-val :lambda-list '(m))
(cl:defmethod ygyro-val ((m <SIMSTATE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:ygyro-val is deprecated.  Use mavlink_ardupilotmega-msg:ygyro instead.")
  (ygyro m))

(cl:ensure-generic-function 'zgyro-val :lambda-list '(m))
(cl:defmethod zgyro-val ((m <SIMSTATE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:zgyro-val is deprecated.  Use mavlink_ardupilotmega-msg:zgyro instead.")
  (zgyro m))

(cl:ensure-generic-function 'lat-val :lambda-list '(m))
(cl:defmethod lat-val ((m <SIMSTATE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:lat-val is deprecated.  Use mavlink_ardupilotmega-msg:lat instead.")
  (lat m))

(cl:ensure-generic-function 'lng-val :lambda-list '(m))
(cl:defmethod lng-val ((m <SIMSTATE>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:lng-val is deprecated.  Use mavlink_ardupilotmega-msg:lng instead.")
  (lng m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SIMSTATE>)))
  ...
  "mavlink_ardupilotmega/SIMSTATE")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SIMSTATE)))
  "Returns string type for a message object of type 'SIMSTATE"
  "mavlink_ardupilotmega/SIMSTATE")
