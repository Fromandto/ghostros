...
(cl:defmethod cl:initialize-instance :after ((m <LIMITS_STATUS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LIMITS_STATUS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_ardupilotmega-msg:<LIMITS_STATUS> is deprecated: use mavlink_ardupilotmega-msg:LIMITS_STATUS instead.")))
...
(cl:defmethod limits_state-val ((m <LIMITS_STATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:limits_state-val is deprecated.  Use mavlink_ardupilotmega-msg:limits_state instead.")
  (limits_state m))

(cl:ensure-generic-function 'last_trigger-val :lambda-list '(m))
(cl:defmethod last_trigger-val ((m <LIMITS_STATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:last_trigger-val is deprecated.  Use mavlink_ardupilotmega-msg:last_trigger instead.")
  (last_trigger m))

(cl:ensure-generic-function 'last_action-val :lambda-list '(m))
(cl:defmethod last_action-val ((m <LIMITS_STATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:last_action-val is deprecated.  Use mavlink_ardupilotmega-msg:last_action instead.")
  (last_action m))

(cl:ensure-generic-function 'last_recovery-val :lambda-list '(m))
(cl:defmethod last_recovery-val ((m <LIMITS_STATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:last_recovery-val is deprecated.  Use mavlink_ardupilotmega-msg:last_recovery instead.")
  (last_recovery m))

(cl:ensure-generic-function 'last_clear-val :lambda-list '(m))
(cl:defmethod last_clear-val ((m <LIMITS_STATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:last_clear-val is deprecated.  Use mavlink_ardupilotmega-msg:last_clear instead.")
  (last_clear m))
...
(cl:defmethod mods_enabled-val ((m <LIMITS_STATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:mods_enabled-val is deprecated.  Use mavlink_ardupilotmega-msg:mods_enabled instead.")
  (mods_enabled m))

(cl:ensure-generic-function 'mods_required-val :lambda-list '(m))
(cl:defmethod mods_required-val ((m <LIMITS_STATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:mods_required-val is deprecated.  Use mavlink_ardupilotmega-msg:mods_required instead.")
  (mods_required m))

(cl:ensure-generic-function 'mods_triggered-val :lambda-list '(m))
(cl:defmethod mods_triggered-val ((m <LIMITS_STATUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:mods_triggered-val is deprecated.  Use mavlink_ardupilotmega-msg:mods_triggered instead.")
  (mods_triggered m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LIMITS_STATUS>)))
  ...
  "mavlink_ardupilotmega/LIMITS_STATUS")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LIMITS_STATUS)))
  "Returns string type for a message object of type 'LIMITS_STATUS"
  "mavlink_ardupilotmega/LIMITS_STATUS")
