...
(cl:defmethod cl:initialize-instance :after ((m <AHRS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AHRS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_ardupilotmega-msg:<AHRS> is deprecated: use mavlink_ardupilotmega-msg:AHRS instead.")))
...
(cl:defmethod omegaIx-val ((m <AHRS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:omegaIx-val is deprecated.  Use mavlink_ardupilotmega-msg:omegaIx instead.")
  (omegaIx m))

(cl:ensure-generic-function 'omegaIy-val :lambda-list '(m))
(cl:defmethod omegaIy-val ((m <AHRS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:omegaIy-val is deprecated.  Use mavlink_ardupilotmega-msg:omegaIy instead.")
  (omegaIy m))

(cl:ensure-generic-function 'omegaIz-val :lambda-list '(m))
(cl:defmethod omegaIz-val ((m <AHRS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:omegaIz-val is deprecated.  Use mavlink_ardupilotmega-msg:omegaIz instead.")
  (omegaIz m))

(cl:ensure-generic-function 'accel_weight-val :lambda-list '(m))
(cl:defmethod accel_weight-val ((m <AHRS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:accel_weight-val is deprecated.  Use mavlink_ardupilotmega-msg:accel_weight instead.")
  (accel_weight m))

(cl:ensure-generic-function 'renorm_val-val :lambda-list '(m))
(cl:defmethod renorm_val-val ((m <AHRS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:renorm_val-val is deprecated.  Use mavlink_ardupilotmega-msg:renorm_val instead.")
  (renorm_val m))

(cl:ensure-generic-function 'error_rp-val :lambda-list '(m))
(cl:defmethod error_rp-val ((m <AHRS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:error_rp-val is deprecated.  Use mavlink_ardupilotmega-msg:error_rp instead.")
  (error_rp m))

(cl:ensure-generic-function 'error_yaw-val :lambda-list '(m))
(cl:defmethod error_yaw-val ((m <AHRS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:error_yaw-val is deprecated.  Use mavlink_ardupilotmega-msg:error_yaw instead.")
  (error_yaw m))
