...
(cl:defmethod cl:initialize-instance :after ((m <DIGICAM_CONTROL>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DIGICAM_CONTROL)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink_ardupilotmega-msg:<DIGICAM_CONTROL> is deprecated: use mavlink_ardupilotmega-msg:DIGICAM_CONTROL instead.")))
...
(cl:defmethod session-val ((m <DIGICAM_CONTROL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:session-val is deprecated.  Use mavlink_ardupilotmega-msg:session instead.")
  (session m))

(cl:ensure-generic-function 'zoom_pos-val :lambda-list '(m))
(cl:defmethod zoom_pos-val ((m <DIGICAM_CONTROL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:zoom_pos-val is deprecated.  Use mavlink_ardupilotmega-msg:zoom_pos instead.")
  (zoom_pos m))

(cl:ensure-generic-function 'zoom_step-val :lambda-list '(m))
(cl:defmethod zoom_step-val ((m <DIGICAM_CONTROL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:zoom_step-val is deprecated.  Use mavlink_ardupilotmega-msg:zoom_step instead.")
  (zoom_step m))

(cl:ensure-generic-function 'focus_lock-val :lambda-list '(m))
(cl:defmethod focus_lock-val ((m <DIGICAM_CONTROL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:focus_lock-val is deprecated.  Use mavlink_ardupilotmega-msg:focus_lock instead.")
  (focus_lock m))

(cl:ensure-generic-function 'shot-val :lambda-list '(m))
(cl:defmethod shot-val ((m <DIGICAM_CONTROL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink_ardupilotmega-msg:shot-val is deprecated.  Use mavlink_ardupilotmega-msg:shot instead.")
  (shot m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DIGICAM_CONTROL>)))
  ...
  "mavlink_ardupilotmega/DIGICAM_CONTROL")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DIGICAM_CONTROL)))
  "Returns string type for a message object of type 'DIGICAM_CONTROL"
  "mavlink_ardupilotmega/DIGICAM_CONTROL")
