"""autogenerated by genpy from mavlink_common/SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST.msg. Do not edit."""
import sys
...
class SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST(genpy.Message):
  _md5sum = "5879dc75137b573705308aab4670d64b"
  _type = "mavlink_common/SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Automatically Generated in 2014-08-12 13:24:39.909097
...
"""
  ...
  __slots__ = ['sysid','compid','group','mode','roll','pitch','yaw','thrust']
  _slot_types = ['uint8','uint8','uint8','uint8','int16[4]','int16[4]','int16[4]','uint16[4]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       sysid,compid,group,mode,roll,pitch,yaw,thrust
    ...
    """
    if args or kwds:
      super(SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST, self).__init__(*args, **kwds)
